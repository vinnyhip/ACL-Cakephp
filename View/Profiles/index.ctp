<div class="profiles index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('mes_nascimento');?></th>
			<th><?php echo $this->Paginator->sort('dia_nascimento');?></th>
	...
	<tr>
		...
		<td><?php echo h($profile['Profile']['mes_nascimento']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['dia_nascimento']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['fone']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['celular']); ?>&nbsp;</td>
